...
public class Pingouin implements Comparable<Pingouin>{
    ...
    public void slide(){
    	System.out.println("Slinding at "+this.speed+"mph");
    }
	...
	public boolean equals(Object other) {
		if (!(other instanceof Pingouin)){
			return false;
		}
		
		Pingouin otherPingouin = (Pingouin) other;
		return this.name.equals(otherPingouin.name);
	}*/
